<template>
    <div id="Login" class="bg-white">
        ...
        <div align="center" class="q-mt-lg text-green text-weight-bolder text-h5" color="secondary">
            Se encontró<br>
            <div class="q-mt-lg text-green text-h6">
                Colegio {{ colegio }}
            </div>
        </div>
        ...
        <div class="fit justify-center items-center">
            ...
            <div class="col-10 col-sm-5 col-md-3 col-lg-2">
                <div align="Center">
                    <div class="q-pt-xl">
                        <q-btn unelevated class="q-my-sm text-black" @click="onSubmit" color="amber-7">Continuar</q-btn>
                    </div>
                    <div class="q-pt-none">
